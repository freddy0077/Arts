package com.evergreen.arts.adapter;
...
import com.evergreen.arts.GlideApp;
import com.evergreen.arts.MainActivity;
import com.evergreen.arts.PremiumImageDetail;
import com.evergreen.arts.WallpaperDetail;
import com.evergreen.arts.config.admob;
import com.evergreen.arts.func.DataUrl;
import java.util.Collections;
import java.util.List;
import com.evergreen.arts.FavoritesFragment;
...
public class WallpaperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WallpaperAdapter(Context context, List<DataUrl> data, boolean premium) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        myHolder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PremiumImageDetail.sData = data.get(position);

                if (mPremium){
                    Intent intent = new Intent(context, PremiumImageDetail.class);
